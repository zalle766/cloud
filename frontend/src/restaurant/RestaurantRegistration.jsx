...
const RestaurantRegistration = () => {
  ...
  const validateStep = (step) => {
    ...
    switch (step) {
      ...
      case 3:
        ...
        break
      case 4:
        if (formData.partnershipType === 'partnership') {
          if (!formData.partnerName) newErrors.partnerName = 'اسم الشريك مطلوب'
          if (!formData.partnerPhone) newErrors.partnerPhone = 'رقم هاتف الشريك مطلوب'
        }
        break
      case 5:
        if (!formData.licenseNumber) newErrors.licenseNumber = 'رقم الرخصة مطلوب'
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert('تم إرسال طلب التسجيل بنجاح! سيتم مراجعته من قبل الإدارة خلال 24-48 ساعة.')
  ...
  const renderStepContent = () => {
    switch (currentStep) {
      ...
      case 2:
        return (
          <div className="space-y-6">
            <h3 className="text-lg font-medium text-gray-900">العنوان الدقيق للمطعم</h3>
            <p className="text-sm text-gray-600">أدخل العنوان الدقيق للمطعم ليظهر للعملاء بشكل صحيح</p>
      ...
      case 3:
        return (
          <div className="space-y-6">
            ...
            <p className="text-sm text-gray-600">معلومات صاحب المطعم ستظهر للمدير فقط</p>
      ...
      case 4:
        return (
          <div className="space-y-6">
            ...
            <p className="text-sm text-gray-600">إذا كان المطعم مملوك لشريك أو شركة</p>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`input ${errors.partnerName ? 'border-red-500' : ''}`}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className={`input ${errors.partnerPhone ? 'border-red-500' : ''}`}
                      placeholder="+212 6XX XXX XXX"
                    />
                    {errors.partnerPhone && (
                      <p className="mt-1 text-sm text-red-600">{errors.partnerPhone}</p>
                    )}
                  </div>
      ...
      case 5:
        return (
          <div className="space-y-6">
            <h3 className="text-lg font-medium text-gray-900">الرخص والوثائق</h3>
            <p className="text-sm text-gray-600">معلومات الرخصة ستظهر للمدير للمراجعة</p>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                ...
                {formData.coverImage && (
                  <p className="mt-2 text-sm text-green-600">تم اختيار الصورة: {formData.coverImage.name}</p>
                )}
              </div>
            </div>
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                ...
                {formData.menuImages.length > 0 && (
                  <p className="mt-2 text-sm text-green-600">تم اختيار {formData.menuImages.length} صورة</p>
                )}
              </div>
            </div>
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                ...
                {formData.licenseImages.length > 0 && (
                  <p className="mt-2 text-sm text-green-600">تم اختيار {formData.licenseImages.length} وثيقة</p>
                )}
              </div>
            </div>
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                ...
                <input
                  ...
                  accept="image/*,.pdf"
                  multiple
                  onChange={(e) => handleMultipleFileUpload('ownerDocuments', Array.from(e.target.files))}
                  className="hidden"
                  id="owner-documents"
                />
                <label htmlFor="owner-documents" className="mt-2 btn btn-outline">
                  اختيار وثائق صاحب المطعم
                </label>
                {formData.ownerDocuments.length > 0 && (
                  <p className="mt-2 text-sm text-green-600">تم اختيار {formData.ownerDocuments.length} وثيقة</p>
                )}
              </div>
            </div>
          </div>
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 p-6 rounded-lg space-y-4">
              ...
              <h4 className="text-md font-medium text-gray-800 mt-4">العنوان الدقيق</h4>
              ...
              {formData.partnershipType === 'partnership' && (
                <>
                  <h4 className="text-md font-medium text-gray-800 mt-4">معلومات الشريك</h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    <div><strong>اسم الشريك:</strong> {formData.partnerName}</div>
                    <div><strong>هاتف الشريك:</strong> {formData.partnerPhone}</div>
                    <div><strong>بريد الشريك:</strong> {formData.partnerEmail}</div>
                  </div>
                </>
              )}
              
              <h4 className="text-md font-medium text-gray-800 mt-4">معلومات الرخصة</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div><strong>رقم الرخصة:</strong> {formData.licenseNumber}</div>
                <div><strong>نوع الرخصة:</strong> {formData.licenseType}</div>
                <div><strong>تاريخ الانتهاء:</strong> {formData.licenseExpiryDate}</div>
                <div><strong>الرقم الضريبي:</strong> {formData.taxNumber}</div>
              </div>
            </div>
            ...
            <div className="bg-yellow-50 p-4 rounded-lg">
              ...
              <p className="text-sm text-yellow-700">
                ...
                جميع المعلومات المالية والشخصية ستكون مرئية للمدير فقط.
              </p>
            </div>
          </div>
        )
